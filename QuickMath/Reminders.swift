...
enum Reminders {
    private static let identifier = "leftover.daily.reminder"
    ...
    static func schedule(hour: Int, minute: Int) {
        ...
        content.title = "Check your fridge tonight"
        content.body = "You have items that need using up. Open Leftover to get tonight's idea."
